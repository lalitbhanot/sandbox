...
import com.lalit.worldgdp.AppConfiguration;
...
public class CityAPIControllerTest {
    ...
    public void testGetCities() throws Exception {
        ...
        ResultActions result = this.mockMvc.perform(get("/api/cities/{countryCode}", countryCode)
               ...
               // .andExpect(jsonPath("$[1].name", is("Mumbai (Bombay)")));
